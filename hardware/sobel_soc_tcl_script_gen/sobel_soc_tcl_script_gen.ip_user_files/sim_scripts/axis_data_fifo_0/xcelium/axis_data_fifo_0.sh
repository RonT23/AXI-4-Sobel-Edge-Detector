...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../ipstatic/hdl" +incdir+"../../../../../../../sobel_soc.gen/sources_1/ip/axis_data_fifo_0/hdl" \
  ...
  xmvlog -work axis_infrastructure_v1_1_1 $xmvlog_opts +incdir+"../../../ipstatic/hdl" +incdir+"../../../../../../../sobel_soc.gen/sources_1/ip/axis_data_fifo_0/hdl" \
  "../../../ipstatic/hdl/axis_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axis_data_fifo_v2_0_13 $xmvlog_opts +incdir+"../../../ipstatic/hdl" +incdir+"../../../../../../../sobel_soc.gen/sources_1/ip/axis_data_fifo_0/hdl" \
  "../../../ipstatic/hdl/axis_data_fifo_v2_0_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../ipstatic/hdl" +incdir+"../../../../../../../sobel_soc.gen/sources_1/ip/axis_data_fifo_0/hdl" \
