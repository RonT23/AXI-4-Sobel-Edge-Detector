...
if [ -z "$1" ] ; then
    echo "Usage : $0 <PetaLinux-tools-path>"
    exit 1
fi
...
mkdir -p ../petalinux_os_bin
cp ./images/linux/BOOT.BIN ./images/linux/boot.scr ./images/linux/system.dtb ./images/linux/image.ub ./images/linux/rootfs.tar.gz ../petalinux_os_bin
